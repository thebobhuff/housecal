...
export function AccessGate({ onPaired }) {
  ...
  const pair = async (event) => {
    ...
    try {
      const result = await claimDisplayPairing(code, 'Living room Fire TV');
