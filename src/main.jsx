...
function App() {
  ...
  return <div className={`app-shell ${scene === 1 ? 'photo-display-active' : ''}`}>
    ...
    <main className={`scene-main scene-${scene}`}>
      {scene === 0 && <CalendarScene view={view} setView={setView} week={currentWeek} todayLabel={formatToday()} family={family} activeFilter={activeFilter} setActiveFilter={setActiveFilter} filteredEvents={filteredEvents} events={events} setShowModal={setShowModal} setShowMealModal={setShowMealModal} setToast={setToast} openPhotosPicker={openPhotosPicker} done={done} routines={routines} completeChore={completeChore}/>}
      ...
      {scene === 3 && <RoutinesScene done={done} routines={routines} mealPlan={mealPlan} setShowMealModal={setShowMealModal} completeChore={completeChore} setToast={setToast}/>}
...
function CalendarScene({ view, setView, week, todayLabel, family, activeFilter, setActiveFilter, filteredEvents, events, setShowModal, setShowMealModal, setToast, openPhotosPicker, done, routines, completeChore }) { return <div className="scene-content calendar-scene">
